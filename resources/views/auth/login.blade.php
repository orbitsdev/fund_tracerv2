        ...
        <x-authentication-card-logo />
            ...
            <div class="mt-6">
                ...
                <div class="poppins-regular mt-6 grid grid-cols-1 gap-4  rounded-lg ">
                    <a href="{{route('google.redirect')}}" class="flex w-full items-center justify-center gap-3 rounded-md   px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-100 focus-visible:ring-transparent ">
