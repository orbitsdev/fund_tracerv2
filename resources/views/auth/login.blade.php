            ...
            <div class="mt-6">
                ...
                <div class="relative mt-6 ">
                    <div class="absolute inset-0 flex items-center" aria-hidden="true">
                      <div class="w-full border-t bcg "></div>
                    </div>
                ...
                <div class="poppins-regular mt-6 grid grid-cols-1 gap-4 border rounded-lg bcg shadow ">
                    <a href="#" class="flex w-full items-center justify-center gap-3 rounded-md drop-shadow  px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-100 focus-visible:ring-transparent ">
