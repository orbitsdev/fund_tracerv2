          ...
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
            <li>
              ...
              <ul role="list" class="-mx-2 space-y-1">
                ...
                <li>
                  <a href="{{route('particular.index')}}" class="
                  {{request()->routeIs('particular.index') ? ' bg-gray-50 text-indigo-600 ' : 'text-gray-700'}}  group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold
                 ">
